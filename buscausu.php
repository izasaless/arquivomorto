            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<a href="frmcadusu.php" class="btn btn-lg btn-success"><i class="fa fa-plus"></i> Novo</a>
																...
																while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
																   echo '<tr>
																			...
																			<td>
																			  ...
																			  <a class="btn btn-sm btn-danger" href="excluirusu.php?id='.$linha['codusu'].'"><i class="fa fa-trash"></i> Excluir</a>
																			</td> 

    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="principal.php">
                ...
                <div class="sidebar-brand-text mx-3">Agenda <sup>2022</sup></div>
            </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<a href="frmcadcurso.php" class="btn btn-lg btn-success"><i class="fa fa-plus"></i> Novo</a>
																...
																while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
																   echo '<tr>
																			...
																			<td>
																			  ...
																			  <a class="btn btn-sm btn-danger" href="excluircurso.php?id='.$linha['codcurso'].'"><i class="fa fa-trash"></i> Excluir</a>
																			</td> 

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a class="btn btn-primary" href="buscacurso.php"><i class="fa fa-arrow-left"></i> Voltar</a>
								...
								<div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
										    ...
										    <label>Nome</label><br>
										    <div class="input-group">											
										    <input placeholder="informe o nome do curso" class="form-control" type="text" name="curso" id="curso" >
										    </div>
